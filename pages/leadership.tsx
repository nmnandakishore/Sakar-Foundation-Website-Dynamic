                                ...
                                return (
                                    <div className="grid sm:grid-cols-3 bg-white" key={leader.sys.id}>
                                        ...
                                        <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
                                            ...
                                            <p className="mb-4 text-xs text-gray-800">{fields.designation}</p>
                                            <p className="mb-4 text-sm tracking-wide text-gray-800">
                                                {fields.about}
                                            </p>
                                            <div className="flex items-center space-x-3">
                                                {(fields.twittwrLink) ? (
                                                    <a href={fields.twittwrLink} className="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">
                                                ...
                                                {(fields.facebookLink) ? (
                                                    <a href={fields.facebookLink} className="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">
                                                        <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
                                                            <path
