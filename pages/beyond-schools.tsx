                ...
                <div className="container">
                    <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-10 pt-10 pb-32">
                        ...
                        <div className="lg:py-24">
                            ...
                            <h1 className="py-4 text-6xl text-white">Educating children <br /> for tomorrow</h1>
                            <a className="inline-block text-white bg-humans py-2 px-4 bg-secondary" href="#">Join Now</a>
                        </div>
                    </div>
                </div>                
            </div>
                ...
                <div className="container py-20">
                    <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-10 pt-10">
                        ...
                        <div className='sm:py-20'>
                            <div className="heading text-primary" data-id="2">Beyond Schools</div>
                            <p className="my-5" data-id="2">
                                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
                            </p>

                            <div className="grid grid-cols-1 sm:grid-cols-5 sm:gap-10 pt-10">
                                <div className='py-3 text-center'><i className="text-6xl fa-solid fa-user-graduate text-teal-600"></i></div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-5 sm:gap-10 pt-10">
                                <div className='py-6 text-center'><i className="text-6xl fa-solid fa-award text-teal-600"></i></div>
                                <div className='sm:col-span-4'>
